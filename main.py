...
if __name__ == "__main__":
    ...
    parser.add_argument("--surrogate_enabled", type=bool, default=True, help="Whether to enable the surrogate model for fitness prediction.")
    ...
    evolution = ev(args.population_size, args.architecture_length, args.input_channels, args.generations, args.image_size, args.batch_size, args.epochs, 
                   args.mutation_rate, args.crossover_rate, args.surrogate_enabled)
    evolution.evolve()